...
import com.underthemask.android.core.config.LocalNetworkStartupPolicy

@Composable
fun ComponentActivity.LocalNetworkPermissionGate(content: @Composable () -> Unit) {
    if (!LocalNetworkStartupPolicy.requiresPermissionGate()) {
        content()
        return
    }
...
private fun LocalNetworkPermissionScreen(onRequestPermission: () -> Unit) {
    Column(
        ...
        Column(
            ...
            Text(
                text = "Dozvoli pristup lokalnoj mreži",
            ...
            Text(
                text = "Under The Mask se povezuje sa serverom na istom Wi-Fi-ju. " +
                    "Android mora da dozvoli pristup uređajima na lokalnoj mreži da bi lobby radio.",
